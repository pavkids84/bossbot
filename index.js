...
client.on('message', msg  => 
{
	...
	{
		return msg.channel.send('```'+new Date().setHours(9).toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' })+'```')
	}
	...
	if (msg.content.startsWith('.컷'))
	{
		...
		switch(Bossname)
		{
			...
			Devtimer = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-데블랑 젠타임 30분 전\n\n데블랑 젠타임 : ' + Devtime.toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' }) + '```'); Devago = 1}, Devtime.getTime()-new Date().setHours(9).getTime()-1800000)
			Devtimerr = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-야생의 데블랑이 나타났다.```'); Devtime = null; Devago = 0}, Devtime.getTime()-new Date().setHours(9).getTime())
			if(Dcheck)
			{
				Dcheck = 0
			}					
			...
			Bigtimer = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-빅마마 젠타임 30분 전\n\n빅마마 젠타임 : ' + Bigtime.toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' }) + '```'); Bigago = 1}, Bigtime.getTime()-new Date().setHours(9).getTime()-1800000)
			Bigtimerr = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-야생의 빅마마가 나타났다.```'); Bigtime = null; Bigago = 0}, Bigtime.getTime()-new Date().setHours(9).getTime())
			if(Bcheck)
			{
				Bcheck = 0
			}					
			...
			Okptimer = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-우크파나 젠타임 30분 전\n\n우크파나 젠타임 : ' + Okptime.toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' }) + '```'); Okpago = 1}, Okptime.getTime()-new Date().setHours(9).getTime()-1800000)
			Okptimerr = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-야생의 우크파나가 나타났다.```'); Okptime = null; Okpago = 0}, Okptime.getTime()-new Date().setHours(9).getTime())
			if(Ocheck)
			{
				Ocheck = 0
			}					
			...
			Diltimer = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-마녀딜린 젠타임 30분 전\n\n마녀딜린 젠타임 : ' + Diltime.toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' }) + '```'); Dilago = 1}, Diltime.getTime()-new Date().setHours(9).getTime()-1800000)
			Diltimerr = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-야생의 마녀딜린이 나타났다.```'); Diltime = null; Dilago = 0}, Diltime.getTime()-new Date().setHours(9).getTime())
			break
			...
			Bastimer = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-바슬라프 젠타임 30분 전\n\n바슬라프 젠타임 : ' + Bastime.toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' }) + '```'); Basago = 1}, Bastime.getTime()-new Date().setHours(9).getTime()-1800000)
			Bastimerr = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-야생의 바슬라프가 나타났다.```'); Bastime = null; Basago = 0}, Bastime.getTime()-new Date().setHours(9).getTime())
			break
			...
			Biltimer = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-빌리어드 젠타임 30분 전\n\n빌리어드 젠타임 : ' + Bastime.toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' }) + '```'); Bilago = 1}, Biltime.getTime()-new Date().setHours(9).getTime()-1800000)
			Biltimerr = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-야생의 빌리어드가 나타났다.```'); Biltime = null; Bilago = 0}, Biltime.getTime()-new Date().setHours(9).getTime())
			break
			...
			Peitimer = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-페이쓰 젠타임 30분 전\n\n페이쓰 젠타임 : ' + Peitime.toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' }) + '```'); Peiago = 1}, Peitime.getTime()-new Date().setHours(9).getTime()-1800000)
			Peitimerr = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-야생의 페이쓰가 나타났다.```'); Peitime = null; Peiago = 0}, Peitime.getTime()-new Date().setHours(9).getTime())
			break
			...
			Illtimer = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-일루스트 젠타임 30분 전\n\n일루스트 젠타임 : ' + Illtime.toLocaleString("ko-KR", { style: 'currency', currency: 'KRW' }) + '```'); Illago = 1}, Illtime.getTime()-new Date().setHours(9).getTime()-1800000)
			Illtimerr = setTimeout(function(){client.channels.cache.get(process.env.channel).send('```diff\n-야생의 일루트스가 나타났다.```'); Illtime = null; Illago = 0}, Illtime.getTime()-new Date().setHours(9).getTime())
			break
	...
	if(msg.content.startsWith('.점검'))
	{
		...
		var year = new Date().setHours(9).getFullYear()
		...
		if (Tochecktime.getTime() < new Date().setHours(9).getTime() || Tochecktime.getTime() < Fromchecktime.getTime() || Fromchecktime == null || Tochecktime == null)
		{
		...
		setTimeout(function(){msg.channel.send('```점검 시작```'); Fcheckago = Tcheckago = 1}, Fromchecktime.getTime()-new Date().setHours(9).getTime())
		setTimeout
			(
				function()
				{
				...
				Tochecktime.getTime()-new Date().setHours(9).getTime()
			)
			return
	}
})
...
function setBT(msg, date, hour, min, sec)
{
	...
	var data_year = new Date().setHours(9).getFullYear()
	var data_mon = new Date().setHours(9).getMonth()
	var data_date = parseInt(msg.content.split(' ')[2]) + date
	var data_hour = parseInt(msg.content.split(' ')[3]) + hour
	var data_min = parseInconst Discord = require('discord.js')
...
client.on('message', msg  => 
{
	...
	if(msg.content.startsWith('.점검'))
	{
		...
		if (Tochecktime.getTime() < new Date().getTime() || Tochecktime.getTime() < Fromchecktime.getTime() || Fromchecktime == null || Tochecktime == null)
		{
			Fromchecktime = null, Tochecktime = null
			return	msg.channel.send('```해당 날짜는 유효하지 않습니다.```')
		...
		setTimeout(function(){msg.channel.send('```점검 시작```'); Fcheckago = Tcheckago = 1}, Fromchecktime.getTime()-new Date().getTime())
		setTimeout
			(
				function()
				{
				...
				Tochecktime.getTime()-new Date().getTime()
			)
			return
	}
})
...
function setBT(msg, date, hour, min, sec)
{
	...
	var data_mon = new Date().getMonth()
	var data_date = parseInt(msg.content.split(' ')[2]) + date
	var data_hour = parseInt(msg.content.split(' ')[3]) + hour
	...
	if (retdate.getTime() < new Date().getTime())
	{
		retdate = null
	}
	return retdate
